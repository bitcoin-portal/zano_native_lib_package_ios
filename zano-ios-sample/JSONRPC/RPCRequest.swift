...
public struct RPCRequest: Equatable {
    ...
    init<C>(method: String, checkedParams params: C, id: Int64) throws where C: Codable {
        try self.init(method: method, checkedParams: params, id: .right(id))
    }

    init<C>(method: String, checkedParams params: C, id: String) throws where C: Codable {
    ...
    init<C>(method: String, params: C, id: Int64) where C: Codable {
        self.init(method: method, params: AnyCodable(params), id: .right(id))
    }

    init<C>(method: String, params: C, rpcid: RPCID) where C: Codable {
        self.init(method: method, params: AnyCodable(params), id: rpcid)
    }

    init<C>(method: String, params: C, id: String) where C: Codable {
        self.init(method: method, params: AnyCodable(params), id: .left(id))
    }

    init(method: String, idGenerator: IdentifierGenerator = defaultIdentifierGenerator) {
        self.init(method: method, params: nil, id: idGenerator.next())
    }

    init(method: String, id: Int64) {
        self.init(method: method, params: nil, id: .right(id))
    }

    init(method: String, id: String) {
