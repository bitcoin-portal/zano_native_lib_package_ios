...
public enum ZanoWallet {
    ...
    public static func InitIpPort(ip: String, port: String, working_dir: String, log_level: Int32)
        -> String
    {
        debugPrint("ip is \(ip)")
    ...
    public static func asyncCall(methodName: String, walletId: UInt64, params: String) throws
        -> String
    {
        ZanoAsyncCallShim(methodName, walletId, params)
    }

    // MARK:  Wallet Operations
    public static func asyncGetRestoreInfo(jobId: UInt64) async -> String {
        let data = ZanoTryPullResultDataShim(jobId)
