...
class StringConversionUtils {
    ...
    // Existing methods
    static func convertUnsafeRawPointerToStdString(rawPointer: UnsafeRawPointer)
        -> CxxStdlib.std.string
    {
    ...
    static func swiftStringToStdString(with string: String) -> UnsafeMutableRawPointer {
        ...
        let rawPointer = UnsafeMutableRawPointer.allocate(
            byteCount: cString.count, alignment: MemoryLayout<CChar>.alignment)
